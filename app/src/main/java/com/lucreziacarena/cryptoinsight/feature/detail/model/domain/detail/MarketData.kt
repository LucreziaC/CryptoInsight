...
data class MarketData(
    ...
    val price_change_24h_in_currency: PriceChangeInCurrency,
    val price_change_percentage_14d: Double,
    val price_change_percentage_14d_in_currency: PriceChangeInCurrency,
    val price_change_percentage_1h_in_currency: PriceChangeInCurrency,
    val price_change_percentage_1y: Double,
    val price_change_percentage_1y_in_currency: PriceChangeInCurrency,
    val price_change_percentage_200d: Double,
    val price_change_percentage_200d_in_currency: PriceChangeInCurrency,
    val price_change_percentage_24h: Double,
    val price_change_percentage_24h_in_currency: PriceChangeInCurrency,
    val price_change_percentage_30d: Double,
    val price_change_percentage_30d_in_currency: PriceChangeInCurrency,
    val price_change_percentage_60d: Double,
    val price_change_percentage_60d_in_currency: PriceChangeInCurrency,
    val price_change_percentage_7d: Double,
    val price_change_percentage_7d_in_currency: PriceChangeInCurrency,
    val roi: Any,
